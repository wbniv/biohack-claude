...
- [Project overview](project_overview.md) — Rapid Raccoon is an indie game studio; 3 upcoming games (Ember/Tide/Nocturne); reject Stitch's fake logistics positioning
- [Neon cyan is signature](feedback_design_cyan.md) — `#00f2ff` is the locked-in accent; preserve/amplify it when making design changes
- [Stitch design project](reference_stitch_project.md) — project 16261848696001807042; Mascot Home variant is the design source of truth
- [Always pass -R to gh secret set](feedback_gh_secret_repo_scope.md) — user runs multiple repo clones; secrets have silently landed on the wrong repo
