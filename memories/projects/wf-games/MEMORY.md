...
- [auto-open md files in browser](feedback_md_command.md) — after writing any .md file, always open it in the browser with xdg-open (no need to ask)
- [WF camera system history](project_camera_history.md) — grew powerful "in self defense"; CamShot per-axis locking covers every game mode; no new code per brief
