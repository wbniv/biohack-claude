...
- [forge2d flipper torque](feedback_flipper_torque.md) — flipper torque must be ~40M with density=100; 1200 was imperceptibly slow
- [Apple II canonical form](feedback_apple_ii_canonical.md) — always write "Apple II" in prose; `apple-ii` for paths/slugs
- [Vendor external source](feedback_vendor_external_source.md) — add third-party source as git submodules under `vendor/`, don't repeatedly curl raw GitHub URLs
